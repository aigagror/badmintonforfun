...
const RankingView_1 = __webpack_require__(61);
...
class RanksTable extends React.Component {
    render() {
        return React.createElement("div", null, this.props.ranks.map((rank, idx) => {
...
class RankingView extends React.Component {
    ...
    render() {
        ...
        return React.createElement("div", null,
            ...
            React.createElement(RanksTable, { ranks: this.state.ranks, myRank: this.state.myRanks }));
    }
}
