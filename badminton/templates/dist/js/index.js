...
const react_google_login_1 = __webpack_require__(38);
class GoogleAuthButton extends React.Component {
    render() {
        return React.createElement(react_google_login_1.GoogleLogin, { clientId: "613791656516-s7k2pbsbosa0c83o8omr0m1p1gp9q8vh.apps.googleusercontent.com", buttonText: this.props.text ? this.props.text : "Login", onSuccess: this.props.onSuccess, onFailure: this.props.onFailure, disabled: false, className: "login-button" });
    }
}
...
const GoogleAuthButton_1 = __webpack_require__(37);
const Button_1 = __webpack_require__(42);
const responseGoogle = (response) => {
    console.log(response);
};
const failureGoogle = (response) => {
};
ReactDOM.render(React.createElement(GoogleAuthButton_1.GoogleAuthButton, { onSuccess: responseGoogle, onFailure: failureGoogle }), document.querySelector("member-button"));
