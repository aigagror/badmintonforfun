...
const react_google_login_1 = __webpack_require__(209);
class GoogleAuthButton extends React.Component {
    render() {
        return React.createElement(react_google_login_1.GoogleLogin, { clientId: "613791656516-s7k2pbsbosa0c83o8omr0m1p1gp9q8vh.apps.googleusercontent.com", buttonText: this.props.text ? this.props.text : "Login", onSuccess: this.props.onSuccess, onFailure: this.props.onFailure, disabled: false, className: "login-button interaction-style" });
    }
}
...
const GoogleAuthButton_1 = __webpack_require__(208);
