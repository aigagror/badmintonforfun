...
#         self.assertEqual(response.status_code, 200)
#
#         edit_member_dict = {'email': 'ezhuang2@illinois.edu', 'attr_to_change': 'bio', 'new_value': 'Hello, new bio who dis'}
#         response = self.client.post(reverse('api:edit_member'), edit_member_dict)
#         self.assertEqual(response.json()['status'], 'up')
#         self.assertEqual(response.status_code, 200)
#
#
