...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('startDateTime', models.DateTimeField(verbose_name='date time started')),
                ('scoreA', models.IntegerField()),
                ('scoreB', models.IntegerField()),
                ('endDateTime', models.DateTimeField(blank=True, null=True, verbose_name='date time ended')),
                ('court', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Court')),
            ],
        ),
        migrations.CreateModel(
            name='Party',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('endDate', models.DateField(blank=True, null=True, unique=True, verbose_name='end date of tournament')),
            ],
        ),
        migrations.CreateModel(
            name='Vote',
