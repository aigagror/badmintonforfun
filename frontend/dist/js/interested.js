...
var InterestedForm_1 = __webpack_require__(5);
...
var InterestedForm = /** @class */ (function (_super) {
    ...
    InterestedForm.prototype.handleSubmit = function () {
        console.log("Submitted!");
        return false;
    };
    InterestedForm.prototype.render = function () {
        return React.createElement("form", { onSubmit: this.handleSubmit, className: "big-button" },
            React.createElement("div", { className: "col-center-4" },
                React.createElement("label", null,
                    "Email:",
                    React.createElement("input", { type: "text", id: "email", name: "email", placeholder: "netid@illinois.edu" }))),
            React.createElement("div", { className: "col-center-4" },
